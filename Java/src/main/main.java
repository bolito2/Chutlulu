		...
		chutANormal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
                ...
                for(int i = 0; i < mensaje.length; i++)
                {
                    ...
                    mensajeINT[i] = (int) (Math.cos((mensaje.length - (i + 1)) * Math.PI)*3 +lepraANumero(mensaje[i]) + Math.round(Math.log10 (Math.pow(i + 1, 4.0))) + (int)chutlulu[contadorCHUT] *69);
			...
			public void actionPerformed(ActionEvent e) 
			{
				 char[] chutlulu = new char[] {'c' , 'h' , 'u','t','l','u','l','u'};
	                ...
	                for(int i = 0; i < mensaje.length; i++)
	                {
	                		...
	                		System.out.println((int)mensaje[i]);
	                        ...
	                        System.out.println(mensajeINT[i]);
